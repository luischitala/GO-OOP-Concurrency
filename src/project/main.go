...
//Create a constructor for the worker
...
//Will be in charge the send the jobs to the workers
	...
	for {
		...
		case job := <-d.JobQueue:
			go func() {
				...
				//will send the jobs to the worker job queue
				workerJobQueue <- job
			}()
		}
	}
...
func RequestHandler(w http.ResponseWriter, r *http.Request, jobQueue chan Job) {
	...
	// Will be able to extract parameters to evaluate them
